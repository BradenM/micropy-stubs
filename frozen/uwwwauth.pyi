...
def _digest_resp(auth_d: Any, username: Any, passwd: Any, method: Any, URL: Any) -> Any: ...
    ...
    # ? 0: return format_resp(resp_d)
def basic_resp(username: Any, passwd: Any) -> Any: ...
    #   0: return +ubinascii.b2a_base64(%(username, passwd))[:-].decode()
    # ? 0: return +ubinascii.b2a_base64(%Tuple[username, passwd])[:].decode()
def auth_resp(auth_line: Any, username: Any, passwd: Any, method: Any=, URL: Any=) -> Any: ...
