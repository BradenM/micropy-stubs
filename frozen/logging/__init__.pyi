...
def basicConfig(level: Any=INFO, filename: str=, stream: Any=, format: Any=, style: Any=) -> None: ...
class Handler:
...
class FileHandler(Handler):
    def __init__(self, filename: str, mode: Any=, encoding: Any=, delay: Any=) -> None: ...
    def emit(self, record: Any) -> None: ...
    def close(self) -> None: ...
class Formatter:
    def __init__(self, fmt: Any=, datefmt: Any=, style: Any=) -> None: ...
    ...
    def format(self, record: Any) -> Any: ...
        ...
        # ? 1: return self.fmt.format(None=record.__dict__)
    def formatTime(self, record: Any, datefmt: Any=) -> Any: ...
        #   0: return .format(*ct)
        # ? 0: return .format(*ct)
    def formatException(self, exc_info: Any) -> None: ...
    def formatStack(self, stack_info: Any) -> None: ...
class LogRecord:
    def __init__(self, name: str, level: Any, pathname: Any, lineno: Any, msg: Any, args: Any, exc_info: Any, func: Any=, sinfo: Any=) -> None: ...
