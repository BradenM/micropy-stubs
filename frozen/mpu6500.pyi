...
Node = Any
class MPU6500:
    def __init__(self, i2c: Any, address: Any=, accel_fs: Any=ACCEL_FS_SEL_2G, gyro_fs: Any=GYRO_FS_SEL_250DPS, accel_sf: Any=SF_M_S2, gyro_sf: Any=SF_RAD_S, gyro_offset: Any=(, , )) -> None: ...
    ...
    def whoami(self) -> Any: ...
        ...
        # ? 0: return self._register_char(_WHO_AM_I)
    def calibrate(self, count: Any=, delay: Any=) -> Any: ...
