...
class MQTTClient:
    ...
    def setLastWill(self, topic: Any, payload: Any=, QoS: Any=, retain: Any=) -> None: ...
    ...
    def connect(self, keepAliveInterval: Any=) -> None: ...
    def subscribe(self, topic: Any, qos: Any, callback: Any) -> None: ...
    def publish(self, topic: Any, payload: Any, qos: Any, retain: Any, dup: Any=) -> None: ...
    def _encode_16(self, x: Any) -> Any: ...
        #   0: return struct.pack(x)
        # ? 0: return struct.pack(x)
    def _pascal_string(self, s: str) -> Any: ...
        #   0: return struct.pack(len(s))+s
        # ? 0: return struct.pack(int)+str
    def _encode_varlen_length(self, length: Any) -> Any: ...
        #   0: return buff
        # ? 0: return buff
    def _topic_matches_sub(self, sub: Any, topic: Any) -> Optional[Any]: ...
        #   0: return
        #   0: return 
        #   1: return result
        # ? 1: return result
    def _remove_topic_callback(self, topic: Any) -> Any: ...
        #   0: return deleted
        # ? 0: return deleted
    def unsubscribe(self, topic: Any) -> Optional[Any]: ...
    ...
    def _send_connect(self, keepalive: Any, clean_session: Any) -> Any: ...
        ...
        # ? 0: return self._msgHandler.priority_send(pkt)
    def _send_unsubscribe(self, topic: Any, dup: Any=) -> Any: ...
    ...
    def _send_pubrec(self, msg_id: Any) -> Any: ...
        #   0: return self._msgHandler.push_on_send_queue(pkt)
        # ? 0: return self._msgHandler.push_on_send_queue(pkt)
    def _parse_connack(self, payload: Any) -> None: ...
    def _parse_suback(self, payload: Any) -> None: ...
    def _parse_puback(self, payload: Any) -> None: ...
    def _notify_message(self, message: Any) -> Any: ...
        #   0: return notified
        # ? 0: return notified
    def _parse_publish(self, cmd: Any, packet: Any) -> None: ...
    def _parse_unsuback(self, payload: Any) -> None: ...
    def _parse_pingresp(self) -> None: ...
    def _recv_callback(self, cmd: Any, payload: Any) -> Optional[Any]: ...
