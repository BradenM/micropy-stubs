...
def lstat(name: str) -> Any: ...
    ...
    # ? 0: return stat_result(uos.stat(str))
def getcwd() -> Any: ...
    #   0: return getcwd_(buf)
    # ? 0: return getcwd_(buf)
def mkdir(name: str, mode: Any=) -> None: ...
def rename(old: Any, new: Any) -> None: ...
def unlink(name: str) -> None: ...
def rmdir(name: str) -> None: ...
def makedirs(name: str, mode: Any=, exist_ok: Any=) -> None: ...
def ilistdir(path: Any=) -> None: ...
def listdir(path: Any=) -> Any: ...
    #   0: return res
    # ? 0: return res
def walk(top: Any, topdown: Any=) -> None: ...
def open(n: int, flags: Any, mode: Any=) -> Any: ...
    #   0: return r
    # ? 0: return r
...
def system(command: Any) -> Any: ...
    #   0: return r
    # ? 0: return r
def getenv(var: Any, default: Any=) -> Any: ...
    #   0: return default
    # ? 0: return default
    #   1: return var
    # ? 1: return var
def fsencode(s: str) -> Union[bytes(str), str]: ...
def fsdecode(s: str) -> Union[str, str(str)]: ...
def urandom(n: int) -> Any: ...
    #   0: return f.read(n)
    # ? 0: return f.read(int)
def popen(cmd: Any, mode: Any=) -> Any: ...
