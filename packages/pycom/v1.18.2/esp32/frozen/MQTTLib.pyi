...
class AWSIoTMQTTClient:
    def __init__(self, clientID: Any, protocolType: Any=mqttConst.MQTTv3_1_1, useWebsocket: Any=, cleanSession: Any=) -> None: ...
    ...
    def connect(self, keepAliveIntervalSecond: Any=) -> Any: ...
    ...
    def publish(self, topic: Any, payload: Any, QoS: Any) -> Any: ...
        #   0: return self._mqttClient.publish(topic,payload,QoS)
        # ? 0: return self._mqttClient.publish(topic, payload, QoS)
