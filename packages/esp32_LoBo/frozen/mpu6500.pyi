...
Node = Any
class MPU6500:
    def __init__(self, i2c: Any, address: Any=104, accel_fs: Any=ACCEL_FS_SEL_2G, gyro_fs: Any=GYRO_FS_SEL_250DPS, accel_sf: Any=SF_M_S2, gyro_sf: Any=SF_RAD_S, gyro_offset: Any=(0, 0, 0)) -> None: ...
    def acceleration(self) -> Tuple[Any]: ...
    def gyro(self) -> Tuple[Any]: ...
    def temperature(self) -> Any: ...
        #   0: return temp-_TEMP_OFFSET/_TEMP_SO+_TEMP_OFFSET
        # ? 0: return temp-_TEMP_OFFSET/_TEMP_SO+_TEMP_OFFSET
    def whoami(self) -> Any: ...
        #   0: return self._register_char(_WHO_AM_I)
        # ? 0: return self._register_char(_WHO_AM_I)
    def calibrate(self, count: Any=256, delay: Any=0) -> Any: ...
        #   0: return self._gyro_offset
        # ? 0: return self._gyro_offset
